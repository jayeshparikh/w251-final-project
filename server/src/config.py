...
#project structure
args["CODE_DIRECTORY"] = "/data/models/deep_avsr/video_only"  #absolute path to the code directory
args["DATA_DIRECTORY"] = "/data/lrs3/lrs3_trainval"  #absolute path to the data directory
args["DEMO_DIRECTORY"] = None   #absolute path to the demo directory
args["PRETRAINED_MODEL_FILE"] = "/final/models/pretrained_models.pt" #None #"/final/models/pretrained_model.pt"     #relative path to the pretrained model file
args["TRAINED_MODEL_FILE"] = "/final/models/trained_model_lrs2.pt"   #relative path to the trained model file
args["TRAINED_LM_FILE"] ="/data/models/deep_avsr/video_only/language_model.pt"  #absolute path to the trained language model file
args["TRAINED_FRONTEND_FILE"] = "/data/models/deep_avsr/video_only/visual_frontend.pt" #absolute path to the trained visual frontend file


#data
args["PRETRAIN_VAL_SPLIT"] = 0.01   #validation set size fraction during pretraining
args["NUM_WORKERS"] = 0 #dataloader num_workers argument
...
args["USE_LM"] = True #False  #whether to use language model for decoding


#testing
args["TEST_DEMO_DECODING"] = "search" #"greedy"   #test/demo decoding type - "greedy" or "search"
